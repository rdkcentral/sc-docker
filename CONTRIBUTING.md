...
- Create a pull request [https://github.com/rdkcentral/sc-docker/compare](https://github.com/rdkcentral/sc-docker/compare) when the code changes are ready for review.
- The team will review, and if accepted your changes will be merged to the mainline.

**All changes must be submitted for review with a corresponding issue, [sc-docker/issues](https://github.com/rdkcentral/sc-docker/issues).**
